...
main (int argc, char *argv[])
{
  ...
  */
  OnOffHelper SenderHelper("ns3::TcpSocketFactory", Address(InetSocketAddress(Subnet2IpIfaces.GetAddress(0), port)));
  SenderHelper.SetConstantRate(DataRate("10Mbps"));
  ...
  if (trace)
    {
      ...
      csmaHelper.EnablePcap ("Subnet2", Subnet2Devices);
    }
