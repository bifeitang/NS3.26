...
main (int argc, char *argv[])
{
  ...
  NetDeviceContainer devn0n2 = csmaHelper.Install (n0n2);
  tchPfifo.Install (devn0n2);

  csmaHelper.SetQueue ("ns3::DropTailQueue");
  csmaHelper.SetChannelAttribute ("DataRate", StringValue ("10Mbps"));
  csmaHelper.SetChannelAttribute ("Delay", StringValue ("3ms"));
  NetDeviceContainer devn1n2 = csmaHelper.Install (n1n2);
  ...
  NetDeviceContainer devn3n4 = csmaHelper.Install (n3n4);
  tchPfifo.Install (devn3n4);

  csmaHelper.SetQueue ("ns3::DropTailQueue");
  csmaHelper.SetChannelAttribute ("DataRate", StringValue ("10Mbps"));
  csmaHelper.SetChannelAttribute ("Delay", StringValue ("5ms"));
  NetDeviceContainer devn3n5 = csmaHelper.Install (n3n5);
  ...
  if (writePcap)
    {
      csmaHelper.EnablePcap("devn0n2",devn0n2);
      csmaHelper.EnablePcap("devn1n2",devn1n2);
      csmaHelper.EnablePcap("devn3n4",devn3n4);
      csmaHelper.EnablePcap("devn3n5",devn3n5);
      p2p.EnablePcap("devn2n3",devn2n3);
    }
